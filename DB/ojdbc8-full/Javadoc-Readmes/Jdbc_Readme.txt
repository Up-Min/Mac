Oracle JDBC Driver release 21.8.0.0.0 Readme.txt
======================================================

Driver Versions
---------------

These are the driver versions in the 21.8 release:

  - JDBC Thin Driver 21.8
    100% Java client-side JDBC driver for use in client applications,
    middle-tier servers and applets.

  - JDBC OCI Driver 21.8
    Client-side JDBC driver for use on a machine where OCI 21.8
    is installed.

  - JDBC Thin Server-side Driver 21.8
    JDBC driver for use in Java program in the database to access
    remote Oracle databases.

  - JDBC Server-side Internal Driver 21.8
